...
| [Hoàng Trung Hiếu](<../canhan/REPORT_CANHAN (2).md>) | `Metadata-enriched chunking` với `LocalEmbedder`; báo cáo tự ghi bốn câu còn là bản nháp. | Tự chấm 3/10 trên 5 câu nháp. | Khác cấu hình, backend và câu hỏi; chưa có lần chạy cá nhân trên bộ 5 câu chính thức. |
